class Solution {
    ...
    public static boolean isValid(char[][] board,int row,int col,int i){
...
System.out.println("Unsolved Suduko:");
 for (int i = 0; i < board.length; i++) {
        for (int j = 0; j < board.length; j++) {
            ...
            if (j == 2 || j == 5) {
                System.out.print("| "); // Print vertical lines after the 3rd and 6th columns
            }
        }
        System.out.println();
        if (i == 2 || i == 5) {
            System.out.println("---------------------"); // Print horizontal line after the 3rd and 6th rows
        }
    }
solveSudoku( board);
